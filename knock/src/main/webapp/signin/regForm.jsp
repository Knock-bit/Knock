  ...
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <body>
      <div class="main">
        ...
        <div class="container">
          <form method="post" class="regform" id="appointment-form" value="confirm"
            action="${contextPath}/signin/login.jsp?type=logintype=join">
            <center>
            <h1>회원가입</h1>
            <div class="form-group-1">
              <input type="text" name="user_id" id="user_id" name="user_id" placeholder="ID" maxlength="10"
                required /><input type="button" id="dupchk" value="중복확인"></button><br>
              <div style="font-size: 10px; margin-left: auto; font-weight: bold; color:darkgrey;">아이디는 영문3자부터 최대 10자까지
                가능합니다.(영문/숫자혼합)</div><br>
              ...
              <c style="font-size: 10px; font-weight: bold;color:darkgrey;">휴대폰번호 11자리를 하이픈(-)과 함께 입력해주세요.
            </div>


            <input type="number" name="birth" id="birth" placeholder="생년월일" required />
            <div style="font-size: 10px; font-weight: bold;">
              <div id="birthSuccess"></div><br>

              <input type="text" name="zip" id="zip" placeholder="우편번호" required /><input type="button" value="검색"
                id="btnAddr" name="btnAddr">
              <input type="text" name="address" id="addr1" size="50" required><input type="text" name="addr2" id="addr2"
                size="10" placeholder="상세주소">
