...
<script src="join.js"></script>      
    ...
    <body>
      <div class="main">
        <div id="reg-logo"><center><a href="${contextPath }/main.jsp">
...
<div class="container">
<form method="post" class="regform" id="appointment-form" action="/knock/signin?type=join">
    <h1>회원가입</h1>
<div class="form-group-1">
<input type="text" name="user_id" id="user_id" name = "user_id" placeholder="ID" maxlength="10" required /><input type="button" id="dupchk" value="중복확인"><br>
...
<div style="font-size: 10px; font-weight: bold; color:darkgrey;">영문 대소문자, 숫자 혼합 최소 8자에서 16자</div>
...
<input type="text" name="birth" id="birth" maxlength="10" placeholder="생년월일" required />
<div style="font-size: 10px; font-weight: bold;" id="birthSuccess"></div><br>

<input type="text" name="zip" id="zip" placeholder="우편번호" required/>
<input type="button" value="검색" id="btnAddr" name="btnAddr">
<input type="text"  name="address" id="addr1" size="50"required>
<input type="text" name="addr2" id="addr2" size="10" placeholder="상세주소">
