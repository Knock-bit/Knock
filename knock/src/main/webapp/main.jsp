...
<html lang="ko">
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="row text-center">
                    <div class="col-md-4">
                        ...
                        <h4 class="my-3">S-Commerce</h4>
                        <img src="./resources/assets/img/main/img1.png" width="250px">
                    ...
                    <div class="col-md-4">
                        ...
                        <img src="./resources/assets/img/main/img3.png" width="250px">
                        <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima maxime quam architecto quo inventore harum ex magni, dicta impedit.</p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                        ...
                        <img src="./resources/assets/img/main/img4.png" width="250px">
                        <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima maxime quam architecto quo inventore harum ex magni, dicta impedit.</p>
                    </div>
                </div>
            </div>
        ...
        <section class="page-section" id="services">
            <div class="container">
                ...
                <div class="row">
              <% CampaignIngDAO campaignIngDAO = new CampaignIngDAO ();
					List<CampaignIngVO> list = campaignIngDAO.list();%>
				<jsp:useBean id="dao" class="com.knock.model.dao.CampaignIngDAO" scope="session" />
        		<c:forEach var="vo" items="${dao.list() }" end="2">
  ...
  <div class="card-body">
    ...
    <div class="footer">
	                 <p><a class="waves-effect waves-light btn" href="${contextPath }/campaign?type=ingOne&idx=${vo.campaign_idx }">Read More</a><a id="heart"><span class="like"><i class="fab fa-gratipay"></i>Like</span></a></p>
	                 <p class="txt3"><i class="far fa-clock"></i> ${endDate - now}일 남았어요
	             </div>
  </div>
</div></div>
                ...
                <ul class="timeline">
                    ...
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>March 2021</h4>
                                <h4 class="subheading">A Study-Group is Born</h4>
                            </div>
                            <div class="timeline-body"><p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente, totam reiciendis temporibus qui quibusdam, recusandae sit vero unde, sed, incidunt et ea quo dolore laudantium consectetur!</p></div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>April 2021</h4>
                                <h4 class="subheading">Transition to Project</h4>
                            </div>
                            <div class="timeline-body"><p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente, totam reiciendis temporibus qui quibusdam, recusandae sit vero unde, sed, incidunt et ea quo dolore laudantium consectetur!</p></div>
                        </div>
                    </li>
