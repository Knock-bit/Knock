                    ...
                    <div class="card h-100">
                      ...
                      <div class="card-body">
                        ...
                        <p class="text-muted"> ${vo.c_content } &nbsp;&nbsp;
                          ...
                          <c:if test="${!empty vo.keyword1}">
                           # ${vo.keyword1}
                          </c:if>
                          <c:if test="${!empty vo.keyword2}">
                           # ${vo.keyword2}
                          </c:if>
                          <c:if test="${!empty vo.keyword3}">
                           # ${vo.keyword3}
                          </c:if>

                        </p>
                        <div class="footer">
                          <p><a class="waves-effect waves-light btn" href="#">Read More</a><a id="heart"><span
                                class="like"><i class="fab fa-gratipay"></i>Like</span></a></p>
                          <p class="txt3"><i class="far fa-clock"></i>${endDate - now}일 남았어요<span class="comments"><i
                                class="fas fa-comments"></i>45 Comments</span></p>
                        </div>
                      </div>
                    </div>
                  </div>
