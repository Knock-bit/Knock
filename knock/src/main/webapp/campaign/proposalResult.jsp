...
<link href="https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@300&display=swap" rel="stylesheet">
      <!-- STYLE CSS -->
      <link rel="stylesheet" href="${contextPath }/resources/css/proposalStyle.css">
   </head>
      ...
      <div class="wrapper">
         <div class="inner">
            <div id="campaignForm"">
               ...
               <button class="button" onclick="location.href='campaign?type=ingList'">&nbsp;&nbsp;캠페인 메인화면
                  <i class="zmdi zmdi-arrow-right"></i>
               </button>
               <button class="button" onclick="location.href='${contextPath}/main.jsp'">&nbsp;&nbsp;메인으로 돌아가기
                  <i class="zmdi zmdi-arrow-right"></i>
               </button>
          </div>
         </div>
